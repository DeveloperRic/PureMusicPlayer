Public Class Tile
    ...
    Public Sub handleClick()
        Select Case _type
            Case TileManager.TileType.HOME
                MainPlayer.CurrentPage = MainPlayer.MainPlayerPage.HOME
            Case TileManager.TileType.IMPORT_TRACKS
                ImportTracks.Show()
            Case TileManager.TileType.QUEUE
                MainPlayer.CurrentPage = MainPlayer.MainPlayerPage.QUEUE
